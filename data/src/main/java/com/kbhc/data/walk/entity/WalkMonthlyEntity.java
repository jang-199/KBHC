...
import com.kbhc.data.walk.entity.converter.YearMonthAttributeConverter;
...
@Entity
@NoArgsConstructor
@Convert(converter = YearMonthAttributeConverter.class, attributeName = "month")
public class WalkMonthlyEntity extends BaseEntity {
    @Id @Tsid
    private Long id;
    ...
    @Builder
    public WalkMonthlyEntity(UUID recordKey, YearMonth month, BigDecimal steps, BigDecimal distance, BigDecimal calories) {
